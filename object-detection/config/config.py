...
BUTTON_CONFIG = {
    'serial_port': 'COM11',  # Default serial port for Arduino Mega
...
BUTTON_FEEDBACK = {
    ...
    'sound_volume': 0.5,
    'sound_files': {
        'button_press': 'assets/sounds/buttons/vocal.wav',
        'button_release': 'assets/sounds/buttons/a5598bcd-98d9-4899-8ef0-c44c28db7137.wav',
        'error': 'assets/sounds/buttons/error.wav',
        'success': 'assets/sounds/buttons/success.wav'
    },
    'visual_enabled': True,
    'visual_duration': 200,  # milliseconds
    'haptic_enabled': False,  # For future haptic feedback support
    'led_feedback': True      # For Arduino LED feedback
}

...
class AutoAnnotator:
    def __init__(self, data_dir, output_dir, confidence_threshold=0.35, text_threshold=0.25):
        ...
        self.categories = {
            ...
            "CAR_FIRE": ["Car engulfed in flames", "Car on fire"],
            ...
            "POLICE": ["Law enforcement personnel", "police man"],
            "POLICE_VEHICLE": ["Police vehicle", "Police car", "Police Truck"],
            "POLICE_MAN": ["Uniformed police officer"],
    ...
    def get_image_paths(self):
        """Get all image paths from the armored_vehicles directory."""
        image_paths = []
        ...
        logging.info(f"Found {len(image_paths)} images to annotate")
        return image_paths
